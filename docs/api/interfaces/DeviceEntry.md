...
- [`ExpandedDeviceEntry`](ExpandedDeviceEntry.md)
...
| <a id="property-transports"></a> `transports` | [`DeviceTransports`](DeviceTransports.md) | Wire-protocol transports this device exposes. |
