...
- [`EngineDescriptor`](EngineDescriptor.md)

## Properties

| Property | Type | Description |
| ------ | ------ | ------ |
| <a id="property-bind"></a> `bind?` | [`EngineBind`](EngineBind.md) | Per-engine routing hints. Omit on single-engine devices. See `EngineBind` for transport-layer vs protocol-layer routing. |
| <a id="property-capabilities"></a> `capabilities?` | [`PrintEngineCapabilities`](PrintEngineCapabilities.md) | Engine-level capability flags. See `PrintEngineCapabilities`. |
